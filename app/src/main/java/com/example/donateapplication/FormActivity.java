...
public class FormActivity extends AppCompatActivity
    ...
    Button NextBtn;
    int Unit=R.array.Units1;
    Spinner F_Type,Dist,States,unit;
    String userId, email,foodtype,dist,states,unit_str;
    ...
    ArrayAdapter<CharSequence> FoodType_adapter,District_adapter,States_adapter,Unit_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        F_Type = (Spinner) findViewById(R.id.FoodTypeSpinner);
        ...
        if (ActivityCompat.checkSelfPermission(FormActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(FormActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 0);
        }
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
         ...
         FoodType_adapter = ArrayAdapter.createFromResource(this,
                R.array.FoodType, android.R.layout.simple_spinner_item);
        FoodType_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        F_Type.setAdapter(FoodType_adapter);
        F_Type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(foodtype=="Breakfast" | foodtype=="Lunch" | foodtype=="Snacks" | foodtype=="Dinner"| foodtype=="Fruits"){

                  Unit=R.array.Units1;


                }
                if(foodtype=="Beverages" | foodtype=="Dairy Foods"){
        ...
        Unit_adapter = ArrayAdapter.createFromResource(FormActivity.this,
               Unit, android.R.layout.simple_spinner_item);
       ...
       District_adapter = ArrayAdapter.createFromResource(this,
        ...
        NextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String quantity = Que.getText().toString().trim()+" "+unit_str;
                ...
                if (TextUtils.isEmpty(title)) {
                    ...
                    ConfomationDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            model mod = new model(name, title, email, add, foodname, foodtype, pickupdate, pickuptime, quantity, description,dist,states);
                            ...
                            //*    Intent intent = new Intent(FormActivity.this,PicActivity.class);
                ...
                if(location!=null){
                    ...
                    try{
                       ...
                       // Add.setText(addressesList.get(0).);
                        ...
                        Toast.makeText(FormActivity.this, "Error:" +e, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(FormActivity.this, "Location null error", Toast.LENGTH_SHORT).show();
